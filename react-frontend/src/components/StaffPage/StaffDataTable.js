...
const pTemplate2 = (rowData, { rowIndex }) => <p >{rowData.bahagian}</p>
...
<Column field="bahagian" header="Bahagian" body={pTemplate2} sortable style={{ minWidth: "8rem" }} />
        ...
        <Dialog header="Upload Staff Data" visible={showUpload} onHide={() => setShowUpload(false)}>
        <UploadService />
      </Dialog>
        </>
    );
